package com.cleven.clchat.home.CLEmojiCommon.adapter.emoticonadapter;

import android.content.Context;
import android.view.View;
import com.cleven.clchat.R;
import com.cleven.clchat.home.CLEmojiCommon.utils.ImageLoadUtils;
        ...
        viewHolder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnEmoticonClickListener != null) {
                    mOnEmoticonClickListener.onEmoticonClick(emoticonEntity, CLEmojiCommonUtils.EMOTICON_CLICK_BIGIMAGE, isDelBtn);
                }
            }
        });
    }
